...
const services = [
  {
    title: '3D Mapping',
    description: '3D mapping is a spectacular animation show projected onto any surface—buildings, sculptures, water, gas, or even cars. Our expertise makes these visual miracles possible.\nTransform ordinary surfaces into extraordinary visual experiences with the magic of 3D mapping.',
  ...
  },
  {
    ...
    description: 'Visual storytelling is the best way to convey a message. It has six times the impact of written or spoken information. Even a small 3D animation can leave unforgettable emotions, especially when crafted by our talented team.\nLet us help you convey your message memorably through stunning animations.',
  ...
  {
    title: 'AR/VR',
    description: 'AR and VR enhance or replace real-life environments with immersive simulations. We combine programming, animation, and design to offer comprehensive AR/VR services.\nHarness AR/VR to captivate your audience and bring your visions to life.',
  ...
  {
    title: 'Performance',
    description: 'Every performance is a unique work of art. We offer creative solutions like interactive dance, 3D mapping, and laser shows. Our shows are crafted with interactive animation to ensure a memorable and engaging experience for your audience.\nOur performance shows are crafted with interactive animation to ensure a memorable and engaging experience for your audience.',

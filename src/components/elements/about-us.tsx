  ...
  return (
    ...
    >
      ...
      <div className="about-us-text text-center font-phosphate text-8xl uppercase 2xl:text-7xl xl:text-6xl md:text-5xl sm:text-4xl">
        ...
        <div className="text-gradient-orange inline-block"> animation</div> and{' '}
        <div className="text-gradient-red-to-blue inline-block">design studio</div> that transforms
        your ideas into stunning visual content. From concept to final video, we{' '}
        <div className="text-gradient-blue inline-block">handle</div>{' '}
        <div className="text-gradient-orange inline-block">every step</div> with a dedicated team of
        professionals.
      </div>
    </section>
  );

  ...
  return (
    ...
    >
      ...
      <div className="about-us-text text-center font-phosphate text-8xl uppercase 2xl:text-7xl xl:text-6xl md:text-5xl sm:text-4xl">
        ...
        <em className="text-gradient-orange inline-block leading-loose"> animation</em> and{' '}
        <em className="text-gradient-red-to-blue inline-block leading-loose">design studio</em> that
        transforms your ideas into stunning visual content. From concept to final video, we{' '}
        <em className="text-gradient-blue inline-block leading-loose">handle</em>{' '}
        <em className="text-gradient-orange inline-block leading-loose">every step</em> with a

  ...
  return (
    ...
    >
      ...
      <div className="about-us-text text-center font-phosphate text-8xl uppercase 2xl:text-7xl xl:text-6xl md:text-5xl sm:text-4xl">
        ...
        <div className="text-gradient-orange inline-block min-h-24 2xl:min-h-[72px] xl:min-h-[60px] md:min-h-12 sm:min-h-14">
          {' '}
          animation
        </div>{' '}
        and{' '}
        <div className="text-gradient-red-to-blue inline-block min-h-24 2xl:min-h-[72px] xl:min-h-[60px] md:min-h-12 sm:min-h-14">
          design studio
        </div>{' '}
        that transforms your ideas into stunning visual content. From concept to final video, we{' '}
        <div className="text-gradient-blue inline-block min-h-24 2xl:min-h-[72px] xl:min-h-[60px] md:min-h-12 sm:min-h-14">
          handle
        </div>{' '}
        <div className="text-gradient-orange inline-block min-h-24 2xl:min-h-[72px] xl:min-h-[60px] md:min-h-12 sm:min-h-14">
          every step

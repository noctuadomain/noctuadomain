  ...
  return (
    ...
    >
      ...
      <div className="about-us-text text-center font-phosphate text-8xl uppercase 2xl:text-7xl xl:text-6xl md:text-5xl sm:text-4xl">
        ...
        <div className="text-gradient-orange block min-h-24 2xl:min-h-[72px] xl:min-h-[60px] md:min-h-12 sm:min-h-10">
          {' '}
          animation
        </div>{' '}
        and{' '}
        <div className="text-gradient-red-to-blue block min-h-24 2xl:min-h-[72px] xl:min-h-[60px] md:min-h-12 sm:min-h-10">
          design studio
        </div>{' '}
        that transforms your ideas into stunning visual content. From concept to final video, we{' '}
        <div className="text-gradient-blue block min-h-24 2xl:min-h-[72px] xl:min-h-[60px] md:min-h-12 sm:min-h-10">
          handle
        </div>{' '}
        <div className="text-gradient-orange block min-h-24 2xl:min-h-[72px] xl:min-h-[60px] md:min-h-12 sm:min-h-10">
          every step

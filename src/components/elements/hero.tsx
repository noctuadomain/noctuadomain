...
const Hero: React.FC<ClassProps> = ({ className }) => {
  return (
    <section className={cn('container relative px-4 flex-space-between md:flex-col', className)}>
      <Glow className="-bottom-[400px] right-20 h-[500px] w-[320px] 3xl:h-[400px] 3xl:w-[270px] 2xl:blur-[60px] xl:-bottom-[300px] xl:right-6 xl:h-[320px] xl:w-[180px] md:-bottom-[200px] md:-right-32 md:size-[335px]" />
      <Glow className="-top-20 left-20 h-[750px] w-[550px] rotate-45 opacity-75 3xl:h-[600px] 3xl:w-[400px] 2xl:blur-[60px] xl:-top-10 xl:h-[420px] xl:w-[320px] lg:h-[350px] lg:w-[250px] md:-left-20 md:-top-20 md:size-[400px]" />
      <div className="flex max-w-[790px] flex-col md:order-2">
        <h1 className="font-phosphate text-[155px] leading-[0.85] 3xl:text-[125px] 2xl:text-[116px] xl:text-[95px] lg:text-[80px] md:mb-5 md:text-center md:text-[116px]">
          ANIMATION STUDIO
        </h1>
        <p className="mb-20 text-xl font-light 2xl:text-base xl:mb-14 xl:text-[14px] lg:mb-10 lg:text-[12px] lg:leading-5 md:mb-5 md:text-center md:text-base">
      ...
      <Image
        className="3xl:size-[775px] 2xl:size-[675px] xl:size-[575px] lg:size-[475px] md:order-1 md:size-[675px]"
